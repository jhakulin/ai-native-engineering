...
When skills are shared across teams or harnesses, `../strategies/ai-asset-registry.md` defines the additional provenance, compatibility, scoped approval, distribution, and lifecycle metadata expected of the registered asset.
