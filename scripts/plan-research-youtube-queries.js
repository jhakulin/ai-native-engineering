...
async function main() {
  ...
  const input = {
    ...
    recent_source_history: compactHistory(readHistory(target.source_history.path, {
      includePullRequests: process.env.RESEARCH_INCLUDE_PR_HISTORY === "true",
    })),
