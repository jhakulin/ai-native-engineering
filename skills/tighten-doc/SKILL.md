---
name: tighten-doc
description: Use this skill when the user asks to tighten, clean up, de-slop, or make a professional document clearer, more concise, less repetitive, or less defensively framed while preserving intent. Mainly user-invoked; do not use for code review, UI copy, legal approval, or strategy redesign unless requested.
---
...
3. Read the document before rewriting.
   ...
   - Identify unnecessary negative framing that explains what the document, session, team, or proposal is not before stating its purpose.
...
4. Name the slop patterns before editing.
   ...
   - Scan for repetition, premature detail, inflated language, generic framing, unnecessary negative framing, overreach, weak specificity, list bloat, and paraphrase slop.
   ...
   - Look for defensive openings, lists of things the work is not, and pre-emptive disclaimers that anticipate misunderstandings without helping the intended audience act.
   - Distinguish unnecessary negative framing from a necessary boundary. Keep negation when it prevents unsafe action, defines scope, preserves a contractual or policy distinction, or supplies a routing false positive. Otherwise remove it, rewrite it as the intended outcome, or move it from audience-facing text into internal guidance.
   - Say the named problems directly. Do not rewrite broadly when a targeted edit is enough.
   - Completion criterion: the document has been checked for repeated ideas, premature detail, inflated language, generic framing, unnecessary negative framing, overreach, weak specificity, list bloat, paraphrase slop, and wording changes that do not improve meaning; each planned edit is tied to one of these named problems, not only a style preference.
...
5. Tighten with minimal change.
   ...
   - Lead with purpose, intended action, or desired outcome. Remove or reposition negation that exists only to defend against hypothetical misreadings.
...
- Defensive openings and long lists describing what something is not.
- Pre-emptive caveats that do not change audience behavior, scope, safety, or interpretation.
...
- Do not convert necessary prohibitions, safety boundaries, scope exclusions, legal distinctions, or routing false positives into positive language that weakens their meaning.
...
- Audience-facing sections lead with purpose or outcome; unnecessary negative framing was removed, rewritten, or moved to appropriate internal guidance.
- Necessary prohibitions and boundaries remain explicit.
