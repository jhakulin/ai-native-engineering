...
| Design an AI-native engineering workflow across teams and tools | [`strategies/ai-native-engineering-workflow-vision.md`](strategies/ai-native-engineering-workflow-vision.md) |
...
Change Review produces an AI-assisted PR review with source-linked findings, file coverage and an assessment against repository-defined criteria. The [Change Review guide](docs/reusable-change-review.md) explains when to use it, how to run it in GitHub Actions and how to interpret the report. It is currently a manual private pilot: it does not run candidate tests, change code or approve merges. Existing skill review is unchanged.
